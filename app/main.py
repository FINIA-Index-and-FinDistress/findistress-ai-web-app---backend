...
# # Define allowed origins with better defaults
# FRONTEND_URLS_RAW = os.getenv(
#     "FRONTEND_URLS", 
#     "https://findistress-web-app-frontend.netlify.app,http://localhost:3000,http://localhost:5173"
# )

# # Parse frontend URLs properly
...
# # Add Netlify preview URLs
# FRONTEND_URLS.extend([
#     "https://*.netlify.app",
#     "https://deploy-preview-*--findistress-web-app-frontend.netlify.app"
# ])

# # Remove duplicates
# FRONTEND_URLS = list(set(FRONTEND_URLS))

# logger.info(f"CORS configured for origins: {FRONTEND_URLS}")

# # FIXED: Add CORS middleware BEFORE other middleware
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=FRONTEND_URLS,
#     allow_credentials=True,
...
#     if origin:
#         for allowed_origin in FRONTEND_URLS:
